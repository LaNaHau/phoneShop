...
<body>
	<div class="auth-background">
		<div class="auth-container">
			...
			<p id="span-email" class="email-display">${email}</p>

			<form class="auth-form" action="form/verify2.htm" method="post">
				...
				<span class="error messenger">${messenger}</span> <span
					class="error opt">${otp}</span> <span class="error">Thời
					gian nhập OTP: <span class="error timer" id="timer">${timer}</span>
				</span> <span class="options again">${again}</span>

				<button type="submit" class="btn-submit" id="btn-veri" name="verify">Xác
					Nhận</button>
				<button type="submit" class="btn-submit" id="btn-again" name="again">Gửi
					lại mã</button>
				<div class="form-group">
