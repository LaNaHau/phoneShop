								...
								<nav aria-label="Page navigation example">
									...
									<ul class="pagination">
										<li class="page-item ${currentPage == 0 ? 'disabled' : ''}"><a
											...
											href="/ShopDienThoai/shop.htm?page=${currentPage - 1}">Trước</a>
										</li>
										<c:if test="${currentPage > 1}">
											<li class="page-item"><a
												class="page-link rounded-0 mr-3 shadow-sm border-top-0 border-left-0 text-dark"
												href="/ShopDienThoai/shop.htm?page=0">1</a></li>
										...
										<c:forEach begin="${startPage}" end="${endPage}" var="i">
											<li class="page-item ${currentPage == i ? 'active' : ''}"><a
												...
												href="/ShopDienThoai/shop.htm?page=${i}">${i + 1}</a></li>
										</c:forEach>
										<c:if test="${currentPage < totalPages - 2}">
											...
											<li class="page-item"><a
												class="page-link rounded-0 mr-3 shadow-sm border-top-0 border-left-0 text-dark"
												href="/ShopDienThoai/shop.htm?page=${totalPages - 1}">${totalPages}</a>
											</li>
										</c:if>
										<li
											...
											<a
											class="page-link rounded-0 mr-3 shadow-sm border-top-0 border-left-0 text-dark"
											href="/ShopDienThoai/shop.htm?page=${currentPage + 1}">Sau</a>
										</li>
									</ul>
								</nav>
							</div>
														...
														<c:if test="${kieu.loai==loai}">
															...
															<div class="form-check">
																<input class="form-check-input" type="checkbox"
																	...
																	id="${kieu.maKieu}" /> <label class="form-check-label"
																	for="${kieu.maKieu}">${kieu.tenKieu}</label>
															</div>
														</c:if>
													</c:forEach>
