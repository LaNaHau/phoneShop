			...
			<div class="row">
				<div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
					...
					<c:if test="${not empty sizeerrorMessage}">
						...
						<f:form action="admin93123/product/edit/${sanPham.maSP}.htm"
							class="tm-edit-product-form" modelAttribute="product"
							...
							<div class="row tm-edit-product-row">
								...
								<div class="col-xl-4 col-lg-4 col-md-12">
									<div class="form-group mb-3">
										...
										<f:input id="masp" path="maSP" type="text"
											class="form-control validate" readonly="true" />
									</div>
									<div class="form-group mb-3">
								...
								<div class="col-xl-4 col-lg-4 col-md-12">
									...
									<div class="form-group mb-3">
										...
										<f:select id="trangThai" path="trangThai"
											class="custom-select">
											<option value="true"
												${sanPham.trangThai ? 'selected="selected"' : ''}>Đang
												bán</option>
											<option value="false"
												${!sanPham.trangThai ? 'selected="selected"' : ''}>Ngừng
												bán</option>
										</f:select>
									</div>
									<div class="form-group mb-3">
									...
									<div class="form-group mb-3">
										...
										<img id="avatar-preview" class="mt-2"
											src="${sanPham.hinhAnh.link}" alt="Avatar preview"
								...
								<div class="col-12">
									<button type="submit"
										class="btn btn-primary btn-block text-uppercase" name="update">
