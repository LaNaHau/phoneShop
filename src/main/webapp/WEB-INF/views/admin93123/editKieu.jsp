			...
			<div class="row">
				<div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
					<div class="tm-bg-primary-dark tm-block tm-block-h-auto">
						...
						<f:form action="admin93123/brands/editKieu/${Kieu.maKieu}.htm"
							class="tm-edit-product-form" modelAttribute="brandForm"
							method="POST">
							<div class="row tm-edit-product-row">
								<div class="col-xl-12 col-lg-12 col-md-12">
									...
									<div class="form-group mb-3" style="display: none;">
										...
										<f:input path="maKieu" type="text" value="${Kieu.maKieu}"
											class="form-control validate" required="true" />
									</div>
									<div class="form-group mb-3">
										<label for="name">Tên kiểu</label>
										<f:input name="tenKieu" path="tenKieu" type="text"
											value="${Kieu.tenKieu}" class="form-control validate"
											required="true" />
									</div>

									<div class="form-group mb-3">
										<label for="category">Kiểu thuộc loại:
											${Kieu.loai.tenLoai}</label>
										<f:select class="custom-select tm-select-accounts"
											id="category" path="loai.maLoai">
											<c:forEach items="${listLoai}" var="l">
												<option value="${l.maLoai}"
													${l.maLoai == Kieu.loai.maLoai ? 'selected' : ''}>${l.tenLoai}</option>
											</c:forEach>
										</f:select>
									</div>
