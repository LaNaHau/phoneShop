...
public class loaiSanPhamController {
	...
	public String timSanPham(ModelMap model, @RequestParam(value = "key", required = false) String key,
		...
		String timKiem = StringEscapeUtils.escapeHtml4(key);
		
	     List<SanPhamEntity>listSP=sanPhamService.laySanPhamTheoMa(timKiem);
	     System.out.println(timKiem);
	     for (SanPhamEntity sanPham : listSP) {
	         System.out.println(sanPham); // Gọi phương thức toString() để in thông tin sản phẩm
	     }
