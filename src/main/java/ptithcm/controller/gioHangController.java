...
public class gioHangController {
	...
	/*
	 * @RequestMapping(value = "/gioHang/{maGh}", params = "updateSize", method =
	 * RequestMethod.POST) public String updateSize(@PathVariable("maGh") int maGh,
	 * HttpServletRequest request, ModelMap model) { System.out.println("gbhjnh");
	 * HttpSession session0 = request.getSession(); NguoiDungEntity user =
	 * (NguoiDungEntity) session0.getAttribute("USER");
	 * 
	 * String size = request.getParameter("size"); System.out.println(size);
	 * 
