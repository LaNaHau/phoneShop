...
public class mainController {
	...
	public String main(HttpServletRequest request, ModelMap model) throws IOException {
		...
		List<CTDonHangEntity> listPhoBien = sanPhamService.laySanPhamPhoBien(10);
		for (CTDonHangEntity item : listPhoBien) {
		    System.out.println(item.getSanPham().getTenSanPham() + ": " + item.getSoLuong());
		}
		...
		List<SanPhamEntity> listKhuyenMai = sanPhamService.laySanPhamKhuyenMai();
