...
public class CTDonHangServiceImpl implements CTDonHangService {
	...
	public List<SanPhamEntity> layDanhSachMaSanPhamTheoMaDH(String maDH){
		return ctDonHangDAO.layDanhSachMaSanPhamTheoMaDH(maDH);
	}
	...
	public int laySoLuongSanPhamTrongDonHang(int maDh, String maSP) {
		return ctDonHangDAO.laySoLuongSanPhamTrongDonHang(maDh, maSP);
	}
	
	@Override
	public List<Object[]> tongSoLuongTheoKieuLoai(int maKieu, int trangThai){
		return ctDonHangDAO.tongSoLuongTheoKieuLoai(maKieu,trangThai);
	}
}
